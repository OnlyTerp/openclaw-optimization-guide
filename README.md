...
> **Skip if** you're already running memory-core with a local embedding provider and a vault — skim for the 2026.4.15-beta.1 `memory_get` / lancedb-cloud changes and move on.
