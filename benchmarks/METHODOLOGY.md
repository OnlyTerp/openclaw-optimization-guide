...
|---|---|---|---|
| **Prod** | Windows 11, RTX 5090 (24 GB VRAM), 128 GB RAM, AMD Ryzen 9 7950X | 2026.5.12 stable | Real 14-agent production deployment (TerpHQ). "Best case with local embedding server." |
| **Baseline** | MacBook Pro M3 Max (36 GB), stock OpenClaw + Ollama | 2026.5.12 stable | Typical developer laptop. Most readers land near this. |
| **Minimal** | Linux VM, 8 GB RAM, no GPU, cloud embedding | 2026.5.12 stable | Low-end. Shows the floor of what the guide still buys you. |
